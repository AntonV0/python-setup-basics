...
# ! Core data types are the basic data types that are built into the Python language. They are used to store and manipulate data in Python programs.
...
print(type(random_list))  # ? <class 'list'>
print(id(random_list))  # ? 1377744646016 - new ID assigned
...
# ! Assignment vs. Object Duplication:
